...
export default function MediumCarousel({playlists, type}){
    return (
        <CarouselProvider className="lg:hidden md:block hidden" naturalSlideWidth={100} isIntrinsicHeight={true} totalSlides={playlists?.length} visibleSlides={2} step={1} infinite={true}>
