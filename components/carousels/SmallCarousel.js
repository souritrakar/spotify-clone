...
export default function SmallCarousel({playlists, type}){
    return (
        <CarouselProvider className="block md:hidden" naturalSlideWidth={100} isIntrinsicHeight={true} totalSlides={playlists?.length} visibleSlides={4} step={1} infinite={true}>
